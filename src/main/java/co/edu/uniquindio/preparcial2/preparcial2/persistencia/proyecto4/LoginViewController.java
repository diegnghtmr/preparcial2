...
import co.edu.uniquindio.preparcial2.preparcial2.persistencia.proyecto1.ModelFactory;
...
public class LoginViewController {
    ...
    private void start(ActionEvent actionEvent) {
        try {
            ...
            ResourceBundle properties = ResourceBundle.getBundle("persistencia/proyecto4/usuarios");
            ...
            if (usuarioProp.equals(usuarioIngresado) && contraseniaProp.equals(contraseniaIngresada)) {
                ...
                navegarVentana("/persistencia/proyecto4/contenedor-view.fxml", "Menú Principal", actionEvent);
            } else {
